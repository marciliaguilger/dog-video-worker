...
- Configure environment access configuration
```
...
- Send a message to the video-queue queue while the application is running locally
```
...
{
    "id": "1d02d221-ac6b-497b-8e46-69862afcb1b0",
    "path": "/videos"
}'

# http://sqs.us-east-1.localhost.localstack.cloud:4566/000000000000/video-queue


- To test receive message at terminal:
```
...
- To create a bucket
aws --endpoint-url=http://localhost:4566 s3 mb s3://video 

- To list buckets 
aws --endpoint-url=http://localhost:4566 s3 ls

- Upload file:
aws --endpoint-url=http://localhost:4566 s3 cp video.mp4 s3://video
